function [dataOut]=northSort(dataIn)

% reduce data to only the North moving cars. Do this by selecting only the
...
for i=1:length(dataIn)
    ...
    if any(strcmp('P',fieldnames(dataIn{i})))==1
        ...
        if length(dataIn{i}.P)>=4
            ...
            %increasing for North, or time is increasing (start of second
            %car)
